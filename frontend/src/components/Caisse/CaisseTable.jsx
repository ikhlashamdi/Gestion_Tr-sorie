    ...
    <div className="w-full mt-10 px-6">
      ...
      {showHeader && (
        <div className="bg-white px-6 py-4 rounded-lg shadow flex items-center justify-between mb-6">
          ...
          <div className="text-sm text-gray-500">
            ...
            <span className="text-gray-500">Caisses</span>
          </div>
        </div>
      )}
      ...
      {showHeader && (
        <div className="mt-4 text-gray-600 font-semibold px-4">
          Liste des Caisses ({caisses.length})
        </div>
      )}
          ...
          <tbody>
            {caisses.length === 0 ? (
              ...
              caisses.map((caisse, idx) => (
                ...
                >
                  <td className="py-3 px-4">{caisse.code}</td>
                  <td className="py-3 px-4">{caisse.libelle}</td>
