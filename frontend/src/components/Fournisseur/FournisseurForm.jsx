...
import { UserCheck, UserPlus, Building, User, Home, Phone, Mail, Hash, Briefcase, Info } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">
              {isEdit ? "Modifier un Fournisseur" : "Nouveau Fournisseur"}
            </h1>
            <p className="text-gray-500 mt-1">
              {isEdit
                ? "Mettre à jour les informations du fournisseur"
                : "Ajouter un nouveau fournisseur à votre société"}
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="Matricule fiscale du fournisseur"
                  />
                </div>
              </div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 mt-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="font-bold text-gray-900">Informations supplémentaires</h3>
                    <p className="text-sm text-gray-500">Ajoutez d'autres détails si nécessaire</p>
                  </div>
                </div>
              </div>
            </div>
