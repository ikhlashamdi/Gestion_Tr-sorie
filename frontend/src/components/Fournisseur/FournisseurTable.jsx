...
export default function FournisseurTable({
  ...
  const getSortedItems = () => {
    const sortableItems = [...fournisseurs];
    if (sortConfig.key) {
  ...
  const filteredFournisseurs = getSortedItems();
    ...
    <div className="px-6 py-6 bg-white rounded-xl shadow-sm">
        ...
        <>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
              ...
              <p className="text-gray-600">Liste des fournisseurs enregistrés</p>
            </div>
          ...
          <div className="mb-6">
            <div className="flex items-center bg-white p-3 rounded-lg border border-gray-300 shadow-sm">
              ...
              <input
                type="text"
                placeholder="Rechercher par code, raison sociale, adresse..."
                value={searchTerm}
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredFournisseurs.length === 0 ? (
              <tr>
                <td colSpan="6" className="px-4 py-6 text-center text-gray-500">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-600 font-medium">Aucun fournisseur trouvé</p>
              ...
              filteredFournisseurs.map((fournisseur) => (
                <tr key={fournisseur._id} className="hover:bg-purple-50 transition-colors">
      ...
      <div className="mt-6 flex justify-between items-center">
        <div className="text-sm text-gray-500">
          {filteredFournisseurs.length} fournisseur(s) affiché(s)
        </div>
      </div>
    </div>
  );
